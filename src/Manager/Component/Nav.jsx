...
export default function Nav() {
  ...
  const [user, setUser] = useState({ username: "Guest", role: "Manager" });
  ...
  return (
    <div className="flex h-screen">
      ...
      `}>
        ...
        {/* Header / Logo */}
        <div className="p-8">
          <div className="flex items-center gap-4 mb-10 group cursor-pointer" onClick={() => navigate('/manager')}>
            ...
            <div>
              ...
              <p className="text-[10px] text-blue-400 font-bold uppercase tracking-[0.2em]">Management Pro</p>
            </div>
          </div>
          ...
          {/* Navigation Links */}
          <nav className="mt-2">
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4 px-4">Menu Manager</p>
